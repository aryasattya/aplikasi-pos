                ...
                <div class="col-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h1 class="card-title">Kategori Produk</h1>
                            <!-- Search form -->
                            <form id="search-form" class="form-inline float-right" action="{{ route('categories.index') }}"
                                method="GET">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('categories.edit', $data->id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $data->id }}" action="{{ route('categories.destroy', $data->id) }}" method="POST" style="display:inline;">
                                                      @csrf
                                                      @method('DELETE')
